...
## New Project Onboarding Page — /new-project tab (04 June 2026)

- [ ] Design page content spec (new-project-spec.md)
- [ ] Create client/src/pages/NewProject.tsx with Track 1 and Track 2 sections
- [ ] Track 1 section: decision criteria, Manus template, 12-step checklist, copy-paste project instructions, bds-meta.json seed, App.tsx template
- [ ] Track 2 section: decision criteria, Manus template, 15-step checklist, copy-paste project instructions, bds-meta.json seed, App.tsx + routers.ts templates
- [ ] Shared section: project naming conventions, registered projects table, post-build link to tracker
- [ ] Page guide callout at top (brief human-readable orientation)
- [ ] Wire /new-project route in App.tsx
- [ ] Add "Start a Project" tab to the top navigation tab bar
- [ ] Add section to SectionNavigator if applicable
- [ ] Update SKILL.md: add /new-project URL to pre-action checklist and handoff_prompt
- [ ] Update PROJECT-CONTEXT.md with new page details
