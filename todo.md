...
- [ ] Make missing and floating component pins produce amber overall tracker status, not only an amber badge
- [ ] Correct the bds-meta-spec copy-paste example to use antiAi.noAiTellWords
- [ ] Add regression coverage for missing and floating component-pin status classification
