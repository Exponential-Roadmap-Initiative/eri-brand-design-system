  ...
  href="https://d2xsxph8kpxj0f.cloudfront.net/310519663319595517/5mtZtU66sMbsnmPoVbf6UJ/favicon-white-rounded-192_54fb4338.png" />`}</pre>
        ...
        <section className="mb-16" id="typography">
          ...
          <p className="text-muted-foreground mb-8 max-w-3xl">
            ...
            <strong>Open Sans</strong> is the body typeface — used for all paragraph text, UI labels, navigation, and captions. Both fonts are self-hosted as WOFF2 files to avoid third-party font requests and support GDPR-compliant delivery.
            ...
            <Card className="shadow-sm">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  ...
                  Self-hosted as WOFF2 in <code className="font-mono text-xs bg-muted px-1 rounded">client/public/fonts/</code>.
                </p>
            ...
            <Card className="shadow-sm">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  ...
                  Weights: 400, 500, 600, 700. Self-hosted as WOFF2 in <code className="font-mono text-xs bg-muted px-1 rounded">client/public/fonts/</code>.
                </p>
                <div className="space-y-1">
        ...
        <section className="mb-16" id="standard-components">
          ...
          <div className="rounded-lg p-5 mb-8 border border-border bg-muted">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs font-mono">
              {[
                { name: "EriStatusBadge.tsx",      url: "https://d2xsxph8kpxj0f.cloudfront.net/310519663319595517/5mtZtU66sMbsnmPoVbf6UJ/components/EriStatusBadge.tsx" },
                { name: "EriContactUsButton.tsx",  url: "https://d2xsxph8kpxj0f.cloudfront.net/310519663319595517/5mtZtU66sMbsnmPoVbf6UJ/components/EriContactUsButton.tsx" },
                { name: "EriAppHeader.tsx",         url: "https://d2xsxph8kpxj0f.cloudfront.net/310519663319595517/5mtZtU66sMbsnmPoVbf6UJ/components/EriAppHeader.tsx" },
      ...
      <Router /> {/* your page router */}
          ...
          <div className="rounded-lg p-4 mb-4 border border-amber-200 bg-amber-50">
            ...
            <ul className="text-xs text-amber-900 space-y-2 list-disc list-inside">
              ...
              <li><strong>Outer background is <code className="font-mono bg-amber-100 dark:bg-amber-900/40 px-1 rounded">#232323</code></strong> — the layout wrapper sets a dark background on the outermost div. Each page component must use <code className="font-mono bg-amber-100 dark:bg-amber-900/40 px-1 rounded">bg-background</code> for its outer page surface (resolving to <code className="font-mono bg-amber-100 dark:bg-amber-900/40 px-1 rounded">#111111</code> in dark mode and <code className="font-mono bg-amber-100 dark:bg-amber-900/40 px-1 rounded">#F9FAFB</code> in light mode). Use the semantic <code className="font-mono bg-amber-100 dark:bg-amber-900/40 px-1 rounded">bg-card</code> token for contained cards and panels; it adapts correctly to each colour mode.</li>
