          ...
          <Card className="shadow-sm mb-3" style={{ backgroundColor: '#1a1a1a' }}>
            <CardContent className="p-0">
              <div className="flex items-center justify-between px-4 py-2 border-b border-gray-700">
                ...
                <a href="https://d2xsxph8kpxj0f.cloudfront.net/310519663319595517/5mtZtU66sMbsnmPoVbf6UJ/EriAppHeader_541af54c.tsx" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-xs text-gray-400 hover:text-white transition-colors"><Download className="w-3 h-3" /> Download</a>
              </div>
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[10px] font-mono bg-muted text-muted-foreground px-2 py-0.5 rounded border border-border">v2.1.0</span>
                ...
                <div className="flex flex-col gap-2 shrink-0">
                  <a
                    href="https://d2xsxph8kpxj0f.cloudfront.net/310519663319595517/5mtZtU66sMbsnmPoVbf6UJ/eri-bds-reference-v2.1.0_50838fc0.skill"
                    download="eri-bds-reference-v2.1.0.skill"
                  ...
                  <p className="text-[10px] text-gray-400 text-center font-mono break-all max-w-[200px]">eri-bds-reference-v2.1.0</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <table className="w-full text-xs mb-4">
                ...
                <tbody className="font-mono text-[11px]">
                  <tr className="border-b border-border/50">
                    ...
                    <td className="py-1.5 pr-3 text-muted-foreground">v2.1.0</td>
                    <td className="py-1.5 text-[#3ba559] break-all">
                      ...
                      >
                        eri-bds-reference-v2.1.0_50838fc0.skill
                      </a>
                    </td>
                  </tr>
                </tbody>
