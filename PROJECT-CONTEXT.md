...
**Current skill version:** v3.0.1 (BDS site updated 2026-05-12 with dark-mode logo docs; skill asset table updated; no version bump required as no new checklist items added)

**Current @eri/components version:** v2.13.0 (2026-05-12) — dark-mode SVG logo in EriAppHeader and EriAppFooter

CDN: `https://d2xsxph8kpxj0f.cloudfront.net/310519663319595517/5mtZtU66sMbsnmPoVbf6UJ/SKILL_bad8a650.md`
