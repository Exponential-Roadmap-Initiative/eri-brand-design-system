...
async function startServer() {
  ...
  const SKILL_LATEST_URL =
    "https://d2xsxph8kpxj0f.cloudfront.net/310519663319595517/5mtZtU66sMbsnmPoVbf6UJ/eri-bds-reference-latest_ab7b0ef4.skill";
  ...
  app.get("/api/skill/latest.json", (_req, res) => {
    ...
    res.json({ url: SKILL_LATEST_URL, version: "2.9.0" }); // overlay spec
  });
