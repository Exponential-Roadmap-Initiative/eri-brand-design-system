...
async function startServer() {
  ...
  const SKILL_LATEST_URL =
    "https://d2xsxph8kpxj0f.cloudfront.net/310519663319595517/5mtZtU66sMbsnmPoVbf6UJ/eri-bds-skill-latest_bf2ef52d.skill";
  ...
  app.get("/api/skill/latest.json", (_req, res) => {
    ...
    res.json({ url: SKILL_LATEST_URL, version: "3.0.0" }); // GDPR fonts, JSON spec endpoint, dark mode rules table
  });
