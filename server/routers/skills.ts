...
export const SKILLS_METADATA: SkillMeta[] = [
  ...
  },
  {
    ...
    description: "Canonical checklist for integrating a new external data source into the ERI platform. Includes known debt catalogue for 11 workspace shell pages and opportunistic migration rule.",
    tier: 3,
    category: "data",
    version: "1.1.0",
