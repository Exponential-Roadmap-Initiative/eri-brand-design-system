...
export const SKILLS_METADATA: SkillMeta[] = [
  ...
  },
  {
    ...
    description: "Canonical patterns for writing, structuring, and testing tRPC routers in the ERI codebase. Includes What Done Means checklist for procedures.",
    tier: 2,
    category: "platform",
    version: "2.1.0",
  ...
  },
  {
    ...
    description: "Pre-implementation checklist (9 gates) for the eri-playbook-team codebase. Covers: no as-any, auth on writes, pagination, transactions, tests, no secrets, Drizzle destructure, frontend architecture, content ownership.",
    tier: 3,
    category: "process",
    version: "2.1.0",
