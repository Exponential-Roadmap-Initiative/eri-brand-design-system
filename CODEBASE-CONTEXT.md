...
Session records are in `CODEBASE-SESSIONS.md` (rolling, last 4–6 sessions).
Older sessions are archived in `CODEBASE-CONTEXT-archive.md`.

**After compaction:** re-read this file first, then `CODEBASE-SESSIONS.md` for recent decisions.
